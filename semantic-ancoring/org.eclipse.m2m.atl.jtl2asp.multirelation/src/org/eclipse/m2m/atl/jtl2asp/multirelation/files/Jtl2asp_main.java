 ...
 *******************************************************************************/
package org.eclipse.m2m.atl.jtl2asp.multirelation.files;
...
public class Jtl2asp_main {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 2) {
				...
				Jtl2asp_main runner = new Jtl2asp_main();
				runner.loadModels(args[0]);
				runner.doJtl2asp_main(new NullProgressMonitor());
	 ...
	 * @generated
	 */
	public Jtl2asp_main() throws IOException {
		properties = new Properties();
		InputStream propertiesInputStream = getFileURL("Jtl2asp_main.properties").openStream();
	 ...
	 * @generated
	 */
	public Object doJtl2asp_main(IProgressMonitor monitor) throws ATLCoreException, IOException, ATLExecutionException {
	...
	protected InputStream[] getModulesList() throws IOException {
		...
		String modulesList = properties.getProperty("Jtl2asp_main.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("Jtl2asp_main.metamodels." + metamodelName);
	}
	...
	protected InputStream getLibraryAsStream(String libraryName) throws IOException {
		return getFileURL(properties.getProperty("Jtl2asp_main.libraries." + libraryName)).openStream();
	}
	...
	protected Map<String, Object> getOptions() {
		...
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("Jtl2asp_main.options.")) {
				options.put(entry.getKey().toString().replaceFirst("Jtl2asp_main.options.", ""), 
	...
	protected static URL getFileURL(String fileName) throws IOException {
		final URL fileURL;
		if (isEclipseRunning()) {
			URL resourceURL = Jtl2asp_main.class.getResource(fileName);
			if (resourceURL != null) {
			...
			fileURL = Jtl2asp_main.class.getResource(fileName);
		}
		if (fileURL == null) {
