 ...
 * given name.
 */
public class JTLMMReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements JTLMM.resource.JTLMM.IJTLMMReferenceCache {
	...
	private JTLMM.resource.JTLMM.IJTLMMNameProvider nameProvider;
	
	public JTLMMReferenceCache(JTLMM.resource.JTLMM.IJTLMMNameProvider nameProvider) {
		super();
