 ...
 */
public class JTLMMDefaultTokenResolver implements JTLMM.resource.JTLMM.IJTLMMTokenResolver {
	 ...
	 */
	public JTLMMDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public JTLMMDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, JTLMM.resource.JTLMM.IJTLMMTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : JTLMM.resource.JTLMM.grammar.JTLMMGrammarInformationProvider.INSTANCE.getKeywords()) {
