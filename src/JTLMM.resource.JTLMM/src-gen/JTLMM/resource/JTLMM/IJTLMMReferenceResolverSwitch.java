...
/**
 * A IJTLMMReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IJTLMMReferenceResolverSwitch extends JTLMM.resource.JTLMM.IJTLMMConfigurable {
