...
public class JTLMMStackFrame extends JTLMM.resource.JTLMM.debug.JTLMMDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private JTLMM.resource.JTLMM.debug.JTLMMDebugTarget target;
	private String name;
	private int id;
	...
	public JTLMMStackFrame(JTLMM.resource.JTLMM.debug.JTLMMDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = JTLMM.resource.JTLMM.util.JTLMMStringUtil.decode(data, ',');
	...
	private JTLMM.resource.JTLMM.debug.JTLMMDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		JTLMM.resource.JTLMM.debug.JTLMMStackFrame other = (JTLMM.resource.JTLMM.debug.JTLMMStackFrame) obj;
		if (name == null) {
