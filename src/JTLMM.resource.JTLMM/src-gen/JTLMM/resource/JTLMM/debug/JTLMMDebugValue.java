...
public class JTLMMDebugValue extends JTLMM.resource.JTLMM.debug.JTLMMDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public JTLMMDebugValue(JTLMM.resource.JTLMM.debug.JTLMMDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
