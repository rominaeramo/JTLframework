 ...
 * conversion.
 */
public interface IJTLMMInputStreamProcessorProvider {
	 ...
	 */
	public JTLMM.resource.JTLMM.mopp.JTLMMInputStreamProcessor getInputStreamProcessor(java.io.InputStream inputStream);
}
