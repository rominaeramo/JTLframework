 ...
 */
public interface IJTLMMOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation().getResourcePostProcessorProviderOptionKey();
