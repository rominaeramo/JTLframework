 ...
 * 
 */
package JTLMM.resource.JTLMM.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class JTLMMLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends JTLMM.resource.JTLMM.util.AbstractJTLMMInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, JTLMM.resource.JTLMM.util.AbstractJTLMMInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final JTLMM.resource.JTLMM.debug.JTLMMDebuggableInterpreter<ResultType, ContextType> interpreter = new JTLMM.resource.JTLMM.debug.JTLMMDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		JTLMM.resource.JTLMM.debug.JTLMMDebuggerListener<ResultType, ContextType> debugListener = new JTLMM.resource.JTLMM.debug.JTLMMDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		JTLMM.resource.JTLMM.debug.JTLMMDebugProcess process = new JTLMM.resource.JTLMM.debug.JTLMMDebugProcess(launch);
		launch.addDebugTarget(new JTLMM.resource.JTLMM.debug.JTLMMDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(JTLMM.resource.JTLMM.launch.JTLMMLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return JTLMM.resource.JTLMM.util.JTLMMResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, JTLMM.resource.JTLMM.mopp.JTLMMPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
