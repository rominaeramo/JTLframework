 ...
 * instance of JTLMMDefaultTokenResolver which performs a standard conversion
 * based on the EMF type conversion. This includes conversion of registered
 * EDataTypes.
 * 
 * @see JTLMM.resource.JTLMM.analysis.JTLMMDefaultTokenResolver
 */
public interface IJTLMMTokenResolver extends JTLMM.resource.JTLMM.IJTLMMConfigurable {
