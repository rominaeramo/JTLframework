 ...
 * to 4 bytes).
 */
public class JTLMMUnicodeConverter extends JTLMM.resource.JTLMM.mopp.JTLMMInputStreamProcessor {
	 ...
	 */
	public JTLMMUnicodeConverter(java.io.InputStream inputStream) {
