...
public class JTLMMRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			JTLMM.resource.JTLMM.mopp.JTLMMPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			JTLMM.resource.JTLMM.mopp.JTLMMPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
