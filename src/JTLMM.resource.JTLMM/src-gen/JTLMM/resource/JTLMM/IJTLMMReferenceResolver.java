 ...
 * resolver
 */
public interface IJTLMMReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends JTLMM.resource.JTLMM.IJTLMMConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, JTLMM.resource.JTLMM.IJTLMMReferenceResolveResult<ReferenceType> result);
