 ...
 */
public class JTLMMEnumerationTerminal extends JTLMM.resource.JTLMM.grammar.JTLMMTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public JTLMMEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, JTLMM.resource.JTLMM.grammar.JTLMMCardinality cardinality, int mandatoryOccurrencesAfter) {
