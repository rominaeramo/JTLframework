...
/**
 * JTLMMLayoutInformation objects are used to store layout information that is
 ...
 * JTLMMLayoutInformations are aggregated in LayoutInformationAdapters. One
 * JTLMMLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class JTLMMLayoutInformation {
	 ...
	 */
	private final JTLMM.resource.JTLMM.grammar.JTLMMSyntaxElement syntaxElement;
	...
	public JTLMMLayoutInformation(JTLMM.resource.JTLMM.grammar.JTLMMSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public JTLMM.resource.JTLMM.grammar.JTLMMSyntaxElement getSyntaxElement() {
