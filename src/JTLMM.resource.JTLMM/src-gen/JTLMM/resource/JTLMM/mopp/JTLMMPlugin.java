 ...
 */
public class JTLMMPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "JTLMM.resource.JTLMM";
	/**
	...
	private static JTLMMPlugin plugin;
	...
	public static JTLMMPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, JTLMMPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, JTLMMPlugin.PLUGIN_ID, message);
		}
		final JTLMMPlugin pluginInstance = JTLMMPlugin.getDefault();
