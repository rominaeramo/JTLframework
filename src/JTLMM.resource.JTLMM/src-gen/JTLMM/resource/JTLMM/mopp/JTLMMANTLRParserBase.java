...
public abstract class JTLMMANTLRParserBase extends org.antlr.runtime3_4_0.Parser implements JTLMM.resource.JTLMM.IJTLMMTextParser {
	 ...
	 * result object.
	 */
	protected java.util.Collection<JTLMM.resource.JTLMM.IJTLMMCommand<JTLMM.resource.JTLMM.IJTLMMTextResource>> postParseCommands;
	 ...
	 */
	private JTLMM.resource.JTLMM.mopp.JTLMMTokenResolveResult tokenResolveResult = new JTLMM.resource.JTLMM.mopp.JTLMMTokenResolveResult();
	...
	public JTLMMANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input) {
		super(input);
	}
	
	public JTLMMANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input, org.antlr.runtime3_4_0.RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(org.eclipse.emf.ecore.EObject element, JTLMM.resource.JTLMM.grammar.JTLMMSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof JTLMM.resource.JTLMM.grammar.JTLMMPlaceholder;
		isElementToStore |= syntaxElement instanceof JTLMM.resource.JTLMM.grammar.JTLMMKeyword;
		isElementToStore |= syntaxElement instanceof JTLMM.resource.JTLMM.grammar.JTLMMEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof JTLMM.resource.JTLMM.grammar.JTLMMBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		JTLMM.resource.JTLMM.mopp.JTLMMLayoutInformationAdapter layoutInformationAdapter = getLayoutInformationAdapter(element);
		...
		layoutInformationAdapter.addLayoutInformation(new JTLMM.resource.JTLMM.mopp.JTLMMLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected <ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> void registerContextDependentProxy(final JTLMM.resource.JTLMM.mopp.JTLMMContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final org.eclipse.emf.ecore.EReference reference, final String id, final org.eclipse.emf.ecore.EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected String formatTokenName(int tokenType)  {
		...
		if (tokenType < 0) {
			...
			tokenName = JTLMM.resource.JTLMM.util.JTLMMStringUtil.formatTokenName(tokenName);
		}
		return tokenName;
	}
	...
	public void setOptions(java.util.Map<?,?> options) {
		...
		if (this.options.containsKey(JTLMM.resource.JTLMM.IJTLMMOptions.DISABLE_LOCATION_MAP)) {
			this.disableLocationMap = true;
		}
		if (this.options.containsKey(JTLMM.resource.JTLMM.IJTLMMOptions.DISABLE_LAYOUT_INFORMATION_RECORDING)) {
	...
	protected void addMapEntry(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, JTLMM.resource.JTLMM.mopp.JTLMMDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof org.eclipse.emf.common.util.EMap<?, ?>) {
			org.eclipse.emf.common.util.EMap<Object, Object> valueMap = JTLMM.resource.JTLMM.util.JTLMMMapUtil.castToEMap(value);
	...
	protected org.eclipse.emf.ecore.EObject apply(org.eclipse.emf.ecore.EObject target, java.util.List<org.eclipse.emf.ecore.EObject> dummyEObjects) {
		...
		for (org.eclipse.emf.ecore.EObject object : dummyEObjects) {
			assert(object instanceof JTLMM.resource.JTLMM.mopp.JTLMMDummyEObject);
			JTLMM.resource.JTLMM.mopp.JTLMMDummyEObject dummy = (JTLMM.resource.JTLMM.mopp.JTLMMDummyEObject) object;
	...
	protected JTLMM.resource.JTLMM.mopp.JTLMMTokenResolveResult getFreshTokenResolveResult() {
		tokenResolveResult.clear();
		return tokenResolveResult;
	}
	
	protected JTLMM.resource.JTLMM.mopp.JTLMMReferenceResolverSwitch getReferenceResolverSwitch() {
		JTLMM.resource.JTLMM.mopp.JTLMMReferenceResolverSwitch resolverSwitch = (JTLMM.resource.JTLMM.mopp.JTLMMReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
