...
public class JTLMMLexer extends Lexer {
    ...
    public JTLMMLexer() {} 
    public JTLMMLexer(CharStream input) {
        this(input, new RecognizerSharedState());
    }
    public JTLMMLexer(CharStream input, RecognizerSharedState state) {
        super(input,state);
    }
    ...
    public final void mT__16() throws RecognitionException {
        try {
            int _type = T__16;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // JTLMM.g:22:7: ( 'checkonly' )
            // JTLMM.g:22:9: 'checkonly'
            {
            match("checkonly"); 
    ...
    public final void mT__18() throws RecognitionException {
        try {
            int _type = T__18;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // JTLMM.g:24:7: ( 'enforce' )
            // JTLMM.g:24:9: 'enforce'
            {
            match("enforce"); 
    ...
    public final void mT__20() throws RecognitionException {
        try {
            int _type = T__20;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // JTLMM.g:26:7: ( 'relation' )
            // JTLMM.g:26:9: 'relation'
            {
            match("relation"); 
    ...
    public final void mT__22() throws RecognitionException {
        try {
            int _type = T__22;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // JTLMM.g:28:7: ( 'transformation' )
            // JTLMM.g:28:9: 'transformation'
            {
    ...
    public final void mTEXT() throws RecognitionException {
        try {
            int _type = TEXT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // JTLMM.g:2793:5: ( ( ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ ) )
            // JTLMM.g:2794:2: ( ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ )
            {
            // JTLMM.g:2794:2: ( ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+ )
            // JTLMM.g:2794:3: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+
            {
            // JTLMM.g:2794:3: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' | '-' )+
            int cnt4=0;
            loop4:
    ...
    public void mTokens() throws RecognitionException {
        // JTLMM.g:1:8: ( T__9 | T__10 | T__11 | T__12 | T__13 | T__14 | T__15 | T__16 | T__17 | T__18 | T__19 | T__20 | T__21 | T__22 | T__23 | T__24 | T__25 | T__26 | T__27 | T__28 | T__29 | SL_COMMENT | ML_COMMENT | TEXT | WHITESPACE | LINEBREAK )
        int alt6=26;
