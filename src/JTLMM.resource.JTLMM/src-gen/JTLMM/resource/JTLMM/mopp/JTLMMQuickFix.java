...
public abstract class JTLMMQuickFix implements JTLMM.resource.JTLMM.IJTLMMQuickFix {
	...
	public JTLMMQuickFix(String displayString, String imageKey, org.eclipse.emf.ecore.EObject contextObject) {
		this(displayString, imageKey, java.util.Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public JTLMMQuickFix(String displayString, String imageKey, java.util.Collection<org.eclipse.emf.ecore.EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public JTLMMQuickFix(String displayString, String imageKey, java.util.Collection<org.eclipse.emf.ecore.EObject> contextObjects, org.eclipse.emf.ecore.resource.Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			new JTLMM.resource.JTLMM.util.JTLMMRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}
