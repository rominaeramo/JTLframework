...
public class JTLMMBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "JTLMM.resource.JTLMM.builder";
	
	private JTLMM.resource.JTLMM.IJTLMMBuilder defaultBuilder = new JTLMM.resource.JTLMM.mopp.JTLMMBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		JTLMM.resource.JTLMM.IJTLMMBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			JTLMM.resource.JTLMM.mopp.JTLMMResource customResource = (JTLMM.resource.JTLMM.mopp.JTLMMResource) resourceSet.getResource(uri, true);
			new JTLMM.resource.JTLMM.mopp.JTLMMMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public JTLMM.resource.JTLMM.IJTLMMBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new JTLMM.resource.JTLMM.mopp.JTLMMMarkerHelper().getMarkerID(JTLMM.resource.JTLMM.JTLMMEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		JTLMM.resource.JTLMM.mopp.JTLMMTaskItemBuilder taskItemBuilder = new JTLMM.resource.JTLMM.mopp.JTLMMTaskItemBuilder();
		new JTLMM.resource.JTLMM.mopp.JTLMMMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation().getSyntaxName())) {
