 ...
 */
public class JTLMMExpectedTerminal {
	...
	private JTLMM.resource.JTLMM.IJTLMMExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private JTLMM.resource.JTLMM.grammar.JTLMMContainmentTrace containmentTrace;
	
	public JTLMMExpectedTerminal(org.eclipse.emf.ecore.EObject container, JTLMM.resource.JTLMM.IJTLMMExpectedElement terminal, int followSetID, JTLMM.resource.JTLMM.grammar.JTLMMContainmentTrace containmentTrace) {
		super();
	...
	public JTLMM.resource.JTLMM.IJTLMMExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		JTLMMExpectedTerminal otherExpectedTerminal = (JTLMMExpectedTerminal) o;
	...
	public JTLMM.resource.JTLMM.grammar.JTLMMContainmentTrace getContainmentTrace() {
