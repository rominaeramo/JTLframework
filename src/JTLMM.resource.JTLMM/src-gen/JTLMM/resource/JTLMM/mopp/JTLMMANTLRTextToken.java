...
public class JTLMMANTLRTextToken extends JTLMM.resource.JTLMM.mopp.JTLMMTextToken {
	
	private final static JTLMM.resource.JTLMM.IJTLMMMetaInformation metaInformation = new JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation();
	
	public JTLMMANTLRTextToken(org.antlr.runtime3_4_0.Token antlrToken) {
