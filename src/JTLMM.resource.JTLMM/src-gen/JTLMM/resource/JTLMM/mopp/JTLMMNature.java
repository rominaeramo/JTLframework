...
public class JTLMMNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "JTLMM.resource.JTLMM.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {JTLMM.resource.JTLMM.mopp.JTLMMBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(JTLMM.resource.JTLMM.mopp.JTLMMBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
