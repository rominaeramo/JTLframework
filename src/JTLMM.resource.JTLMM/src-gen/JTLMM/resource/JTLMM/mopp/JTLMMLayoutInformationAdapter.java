...
/**
 * A JTLMMLayoutInformationAdapter is used to store layout information that is
 ...
 * JTLMMLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class JTLMMLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<JTLMM.resource.JTLMM.mopp.JTLMMLayoutInformation> layoutInformations = new java.util.ArrayList<JTLMM.resource.JTLMM.mopp.JTLMMLayoutInformation>();
	...
	public java.util.List<JTLMM.resource.JTLMM.mopp.JTLMMLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(JTLMM.resource.JTLMM.mopp.JTLMMLayoutInformation layoutInformation) {
