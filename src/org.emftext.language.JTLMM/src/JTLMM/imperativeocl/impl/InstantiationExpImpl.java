 ...
 * </p>
 * <ul>
 *   <li>{@link JTLMM.imperativeocl.impl.InstantiationExpImpl#getInstantiatedClass <em>Instantiated Class</em>}</li>
 *   <li>{@link JTLMM.imperativeocl.impl.InstantiationExpImpl#getExtent <em>Extent</em>}</li>
 *   <li>{@link JTLMM.imperativeocl.impl.InstantiationExpImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstantiationExpImpl extends ImperativeExpressionImpl implements InstantiationExp
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  protected JTLMM.emof.Class instantiatedClass;
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public JTLMM.emof.Class getInstantiatedClass()
  {
		if (instantiatedClass != null && instantiatedClass.eIsProxy()) {
			...
			instantiatedClass = (JTLMM.emof.Class)eResolveProxy(oldInstantiatedClass);
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public JTLMM.emof.Class basicGetInstantiatedClass()
  {
		return instantiatedClass;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public void setInstantiatedClass(JTLMM.emof.Class newInstantiatedClass)
  {
		JTLMM.emof.Class oldInstantiatedClass = instantiatedClass;
  ...
  public void eSet(int featureID, Object newValue)
  {
		switch (featureID) {
			case ImperativeoclPackage.INSTANTIATION_EXP__INSTANTIATED_CLASS:
				setInstantiatedClass((JTLMM.emof.Class)newValue);
				return;
			case ImperativeoclPackage.INSTANTIATION_EXP__EXTENT:
  ...
  public void eUnset(int featureID)
  {
		switch (featureID) {
			case ImperativeoclPackage.INSTANTIATION_EXP__INSTANTIATED_CLASS:
				setInstantiatedClass((JTLMM.emof.Class)null);
				return;
			case ImperativeoclPackage.INSTANTIATION_EXP__EXTENT:
