 ...
 * </p>
 * <ul>
 *   <li>{@link JTLMM.emof.impl.PackageImpl#getOwnedType <em>Owned Type</em>}</li>
 *   <li>{@link JTLMM.emof.impl.PackageImpl#getNestedPackage <em>Nested Package</em>}</li>
 *   <li>{@link JTLMM.emof.impl.PackageImpl#getUri <em>Uri</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageImpl extends NamedElementImpl implements JTLMM.emof.Package
{
  /**
  ...
  public EList<JTLMM.emof.Package> getNestedPackage()
  {
		if (nestedPackage == null) {
			nestedPackage = new EObjectResolvingEList<JTLMM.emof.Package>(JTLMM.emof.Package.class, this, EmofPackage.PACKAGE__NESTED_PACKAGE);
		}
