 ...
 * </p>
 * <ul>
 *   <li>{@link JTLMM.emof.impl.ClassImpl#getOwnedAttribute <em>Owned Attribute</em>}</li>
 *   <li>{@link JTLMM.emof.impl.ClassImpl#getOwnedOperation <em>Owned Operation</em>}</li>
 *   <li>{@link JTLMM.emof.impl.ClassImpl#getSuperClass <em>Super Class</em>}</li>
 *   <li>{@link JTLMM.emof.impl.ClassImpl#isIsAbstract <em>Is Abstract</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassImpl extends TypeImpl implements JTLMM.emof.Class
{
  /**
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  protected EList<JTLMM.emof.Class> superClass;
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EList<JTLMM.emof.Class> getSuperClass()
  {
		if (superClass == null) {
			superClass = new EObjectResolvingEList<JTLMM.emof.Class>(JTLMM.emof.Class.class, this, EmofPackage.CLASS__SUPER_CLASS);
		}
		return superClass;
	}
  ...
  public void eSet(int featureID, Object newValue)
  {
		switch (featureID) {
			...
			case EmofPackage.CLASS__SUPER_CLASS:
				getSuperClass().clear();
				getSuperClass().addAll((Collection<? extends JTLMM.emof.Class>)newValue);
				return;
			case EmofPackage.CLASS__IS_ABSTRACT:
