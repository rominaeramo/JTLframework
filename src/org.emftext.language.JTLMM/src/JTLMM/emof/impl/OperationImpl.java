 ...
 * </p>
 * <ul>
 *   <li>{@link JTLMM.emof.impl.OperationImpl#getTag <em>Tag</em>}</li>
 *   <li>{@link JTLMM.emof.impl.OperationImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link JTLMM.emof.impl.OperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link JTLMM.emof.impl.OperationImpl#getType <em>Type</em>}</li>
 *   <li>{@link JTLMM.emof.impl.OperationImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link JTLMM.emof.impl.OperationImpl#getOwnedParameter <em>Owned Parameter</em>}</li>
 *   <li>{@link JTLMM.emof.impl.OperationImpl#getRaisedException <em>Raised Exception</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationImpl extends MultiplicityElementImpl implements Operation
{
  ...
  public void setClass(JTLMM.emof.Class newClass)
  {
		if (newClass != eInternalContainer() || (eContainerFeatureID() != EmofPackage.OPERATION__CLASS && newClass != null)) {
			...
			if (newClass != null)
				msgs = ((InternalEObject)newClass).eInverseAdd(this, EmofPackage.CLASS__OWNED_OPERATION, JTLMM.emof.Class.class, msgs);
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
  {
		switch (eContainerFeatureID()) {
			case EmofPackage.OPERATION__CLASS:
				return eInternalContainer().eInverseRemove(this, EmofPackage.CLASS__OWNED_OPERATION, JTLMM.emof.Class.class, msgs);
		}
