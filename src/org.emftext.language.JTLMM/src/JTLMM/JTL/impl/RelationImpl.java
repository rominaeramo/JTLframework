...
import JTLMM.emof.impl.NamedElementImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link JTLMM.JTL.impl.RelationImpl#getTransformation <em>Transformation</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.RelationImpl#getDomain <em>Domain</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.RelationImpl#getWhere <em>Where</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.RelationImpl#getWhen <em>When</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.RelationImpl#isIsTopLevel <em>Is Top Level</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.RelationImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationImpl extends NamedElementImpl implements Relation
{
  ...
  public void setWhere(Pattern newWhere)
  {
		if (newWhere != where) {
			NotificationChain msgs = null;
			if (where != null)
				msgs = ((InternalEObject)where).eInverseRemove(this, JTLPackage.PATTERN__WHERE_OWNER, Pattern.class, msgs);
			if (newWhere != null)
				msgs = ((InternalEObject)newWhere).eInverseAdd(this, JTLPackage.PATTERN__WHERE_OWNER, Pattern.class, msgs);
  ...
  public void setWhen(Pattern newWhen)
  {
		if (newWhen != when) {
			NotificationChain msgs = null;
			if (when != null)
				msgs = ((InternalEObject)when).eInverseRemove(this, JTLPackage.PATTERN__WHEN_OWNER, Pattern.class, msgs);
			if (newWhen != null)
				msgs = ((InternalEObject)newWhen).eInverseAdd(this, JTLPackage.PATTERN__WHEN_OWNER, Pattern.class, msgs);
