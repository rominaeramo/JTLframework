/**
 */
package org.emftext.language.JTLMM.impl;
...
import org.emftext.language.JTLMM.DataType;
import org.emftext.language.JTLMM.Entity;
import org.emftext.language.JTLMM.EntityModel;
import org.emftext.language.JTLMM.Feature;
import org.emftext.language.JTLMM.FeatureKind;
import org.emftext.language.JTLMM.JTLMMFactory;
import org.emftext.language.JTLMM.JTLMMPackage;
import org.emftext.language.JTLMM.NamedElement;
import org.emftext.language.JTLMM.Type;
 ...
 * @generated
 */
public class JTLMMPackageImpl extends EPackageImpl implements JTLMMPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.emftext.language.JTLMM.JTLMMPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private JTLMMPackageImpl()
  {
    super(eNS_URI, JTLMMFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link JTLMMPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static JTLMMPackage init()
  {
    if (isInited) return (JTLMMPackage)EPackage.Registry.INSTANCE.getEPackage(JTLMMPackage.eNS_URI);

    // Obtain or create and register package
    JTLMMPackageImpl theJTLMMPackage = (JTLMMPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof JTLMMPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new JTLMMPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theJTLMMPackage.createPackageContents();

    // Initialize created meta-data
    theJTLMMPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theJTLMMPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(JTLMMPackage.eNS_URI, theJTLMMPackage);
    return theJTLMMPackage;
  }
   ...
   * @generated
   */
  public JTLMMFactory getJTLMMFactory()
  {
    return (JTLMMFactory)getEFactoryInstance();
  }
