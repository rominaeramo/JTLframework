 ...
 */
public class JTLMMPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(JTLMM.resource.JTLMM.ui.JTLMMUIPlugin.getDefault().getPreferenceStore());
		setDescription("JTLMM Text Editor Preferences");
	}
