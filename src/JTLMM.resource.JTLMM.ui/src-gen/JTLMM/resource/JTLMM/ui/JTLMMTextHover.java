 ...
 */
public class JTLMMTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private JTLMM.resource.JTLMM.IJTLMMHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final JTLMM.resource.JTLMM.ui.JTLMMBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(JTLMM.resource.JTLMM.ui.JTLMMBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput infoInput = (JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					JTLMM.resource.JTLMM.ui.JTLMMHyperlink hyperlink = new JTLMM.resource.JTLMM.ui.JTLMMHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (JTLMM.resource.JTLMM.ui.JTLMMBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				JTLMM.resource.JTLMM.ui.JTLMMBrowserInformationControl iControl = new JTLMM.resource.JTLMM.ui.JTLMMBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput) {
							JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput input = (JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (JTLMM.resource.JTLMM.ui.JTLMMBrowserInformationControl.isAvailable(parent)) {
				JTLMM.resource.JTLMM.ui.JTLMMBrowserInformationControl iControl = new JTLMM.resource.JTLMM.ui.JTLMMBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public JTLMMTextHover(JTLMM.resource.JTLMM.IJTLMMResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new JTLMM.resource.JTLMM.ui.JTLMMUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		JTLMM.resource.JTLMM.IJTLMMTextResource textResource = resourceProvider.getResource();
	 ...
	 */
	private JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				JTLMM.resource.JTLMM.ui.JTLMMHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			JTLMM.resource.JTLMM.ui.JTLMMHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			JTLMM.resource.JTLMM.ui.JTLMMHTMLPrinter.insertPageProlog(buffer, 0, JTLMM.resource.JTLMM.ui.JTLMMTextHover.getStyleSheet());
			JTLMM.resource.JTLMM.ui.JTLMMHTMLPrinter.addPageEpilog(buffer);
			return new JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = JTLMM.resource.JTLMM.ui.JTLMMHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(JTLMM.resource.JTLMM.ui.JTLMMUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return JTLMM.resource.JTLMM.util.JTLMMStreamUtil.getContent(styleSheetURL.openStream());
