 ...
 */
public class JTLMMCompletionProposal implements java.lang.Comparable<JTLMMCompletionProposal> {
	 ...
	 */
	private JTLMM.resource.JTLMM.mopp.JTLMMExpectedTerminal expectedTerminal;
	...
	public JTLMMCompletionProposal(JTLMM.resource.JTLMM.mopp.JTLMMExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public JTLMMCompletionProposal(JTLMM.resource.JTLMM.mopp.JTLMMExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public JTLMMCompletionProposal(JTLMM.resource.JTLMM.mopp.JTLMMExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public JTLMM.resource.JTLMM.mopp.JTLMMExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof JTLMMCompletionProposal) {
			JTLMMCompletionProposal other = (JTLMMCompletionProposal) object;
	...
	public int compareTo(JTLMMCompletionProposal object) {
		if (object instanceof JTLMMCompletionProposal) {
			JTLMMCompletionProposal other = (JTLMMCompletionProposal) object;
