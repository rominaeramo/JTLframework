...
/**
 * A text editor for 'JTLMM' models.
 * <p>
 * This editor has id <code>JTLMM.resource.JTLMM.ui.JTLMMEditor</code>
 * The editor's context menu has id
 * <code>JTLMM.resource.JTLMM.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>JTLMM.resource.JTLMM.EditorRuler</code>.
 * </p>
 */
public class JTLMMEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, JTLMM.resource.JTLMM.IJTLMMResourceProvider, JTLMM.resource.JTLMM.ui.IJTLMMBracketHandlerProvider, JTLMM.resource.JTLMM.ui.IJTLMMAnnotationModelProvider {
	
	private JTLMM.resource.JTLMM.ui.JTLMMHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private JTLMM.resource.JTLMM.ui.JTLMMCodeFoldingManager codeFoldingManager;
	private JTLMM.resource.JTLMM.ui.JTLMMBackgroundParsingStrategy bgParsingStrategy = new JTLMM.resource.JTLMM.ui.JTLMMBackgroundParsingStrategy();
	private java.util.Collection<JTLMM.resource.JTLMM.IJTLMMBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<JTLMM.resource.JTLMM.IJTLMMBackgroundParsingListener>();
	private JTLMM.resource.JTLMM.ui.JTLMMColorManager colorManager = new JTLMM.resource.JTLMM.ui.JTLMMColorManager();
	private JTLMM.resource.JTLMM.ui.JTLMMOutlinePage outlinePage;
	...
	private JTLMM.resource.JTLMM.ui.JTLMMPropertySheetPage propertySheetPage;
	...
	private JTLMM.resource.JTLMM.ui.IJTLMMBracketHandler bracketHandler;
	...
	public JTLMMEditor() {
		super();
		setSourceViewerConfiguration(new JTLMM.resource.JTLMM.ui.JTLMMSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), JTLMMEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								JTLMM.resource.JTLMM.IJTLMMTextResource currentResource = getResource();
				...
				JTLMM.resource.JTLMM.ui.JTLMMUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("JTLMM.resource.JTLMM.EditorContext");
		setRulerContextMenuId("JTLMM.resource.JTLMM.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new JTLMM.resource.JTLMM.ui.JTLMMHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new JTLMM.resource.JTLMM.ui.JTLMMCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		JTLMM.resource.JTLMM.mopp.JTLMMNature.activate(inputFile.getProject());
		...
		JTLMM.resource.JTLMM.IJTLMMTextResource loadedResource = (JTLMM.resource.JTLMM.IJTLMMTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				JTLMM.resource.JTLMM.IJTLMMTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof JTLMM.resource.JTLMM.IJTLMMTextResource) {
					setResource((JTLMM.resource.JTLMM.IJTLMMTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					JTLMM.resource.JTLMM.ui.JTLMMUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the JTLMMEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				JTLMM.resource.JTLMM.ui.JTLMMUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(JTLMM.resource.JTLMM.IJTLMMTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new JTLMM.resource.JTLMM.ui.JTLMMOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new JTLMM.resource.JTLMM.ui.JTLMMPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			JTLMM.resource.JTLMM.IJTLMMTextResource textResource = (JTLMM.resource.JTLMM.IJTLMMTextResource) element.eResource();
			JTLMM.resource.JTLMM.IJTLMMLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			JTLMM.resource.JTLMM.IJTLMMTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				JTLMM.resource.JTLMM.IJTLMMTextToken token = lexer.getNextToken();
			...
			JTLMM.resource.JTLMM.ui.JTLMMUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!JTLMMEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(JTLMM.resource.JTLMM.IJTLMMBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (JTLMM.resource.JTLMM.IJTLMMBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public JTLMM.resource.JTLMM.ui.IJTLMMBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(JTLMM.resource.JTLMM.ui.IJTLMMBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof JTLMM.resource.JTLMM.IJTLMMTextResource)) {
					return false;
				}
				JTLMM.resource.JTLMM.IJTLMMTextResource textResource = (JTLMM.resource.JTLMM.IJTLMMTextResource) resource;
				JTLMM.resource.JTLMM.IJTLMMLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
