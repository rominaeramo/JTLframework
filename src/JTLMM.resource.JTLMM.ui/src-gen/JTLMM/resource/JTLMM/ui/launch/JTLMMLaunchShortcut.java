 ...
 */
public class JTLMMLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(JTLMM.resource.JTLMM.launch.JTLMMLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			JTLMM.resource.JTLMM.mopp.JTLMMPlugin.logError("Exception while launching selection", e);
		}
	}
