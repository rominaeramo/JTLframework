 ...
 * @since 3.2
 */
public class JTLMMBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput fInput;
	 ...
	 */
	public JTLMMBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public JTLMMBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public JTLMMBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput);
		...
		fInput= (JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput) input;
		...
		JTLMM.resource.JTLMM.ui.JTLMMHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = JTLMM.resource.JTLMM.ui.JTLMMHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public JTLMM.resource.JTLMM.ui.JTLMMDocBrowserInformationControlInput getInput() {
		return fInput;
	}
