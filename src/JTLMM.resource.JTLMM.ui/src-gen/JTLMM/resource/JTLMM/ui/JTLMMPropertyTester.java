...
public class JTLMMPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation().getSyntaxName());
	}
