 ...
 */
public class JTLMMNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("JTLMM.resource.JTLMM.ui");
							...
							String natureID = JTLMM.resource.JTLMM.mopp.JTLMMNature.NATURE_ID;
							...
							for (String builderID : JTLMM.resource.JTLMM.mopp.JTLMMNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation info = new JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = JTLMM.resource.JTLMM.ui.JTLMMUIPlugin.getDefault().getBundle();
