 ...
 */
public class JTLMMSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private JTLMM.resource.JTLMM.ui.JTLMMQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public JTLMMSourceViewerConfiguration(JTLMM.resource.JTLMM.IJTLMMResourceProvider resourceProvider, JTLMM.resource.JTLMM.ui.IJTLMMAnnotationModelProvider annotationModelProvider, JTLMM.resource.JTLMM.ui.IJTLMMBracketHandlerProvider bracketHandlerProvider, JTLMM.resource.JTLMM.ui.JTLMMColorManager colorManager) {
		super(JTLMM.resource.JTLMM.ui.JTLMMUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new JTLMM.resource.JTLMM.ui.JTLMMCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new JTLMM.resource.JTLMM.ui.JTLMMTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new JTLMM.resource.JTLMM.ui.JTLMMTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new JTLMM.resource.JTLMM.ui.JTLMMHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new JTLMM.resource.JTLMM.ui.JTLMMQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new JTLMM.resource.JTLMM.ui.JTLMMIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
