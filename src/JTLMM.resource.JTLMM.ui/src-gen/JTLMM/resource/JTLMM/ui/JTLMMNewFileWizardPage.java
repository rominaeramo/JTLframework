 ...
 */
public class JTLMMNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public JTLMMNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new JTLMM file");
