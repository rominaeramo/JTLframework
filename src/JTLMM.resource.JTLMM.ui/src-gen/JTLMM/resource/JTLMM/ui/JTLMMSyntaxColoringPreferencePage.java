 ...
 */
public class JTLMMSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public JTLMMSyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = JTLMM.resource.JTLMM.ui.JTLMMSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, JTLMM.resource.JTLMM.ui.JTLMMSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = JTLMM.resource.JTLMM.ui.JTLMMSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, JTLMM.resource.JTLMM.ui.JTLMMSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = JTLMM.resource.JTLMM.ui.JTLMMSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, JTLMM.resource.JTLMM.ui.JTLMMSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = JTLMM.resource.JTLMM.ui.JTLMMSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, JTLMM.resource.JTLMM.ui.JTLMMSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = JTLMM.resource.JTLMM.ui.JTLMMSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, JTLMM.resource.JTLMM.ui.JTLMMSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = JTLMM.resource.JTLMM.ui.JTLMMSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, JTLMM.resource.JTLMM.ui.JTLMMSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		JTLMM.resource.JTLMM.ui.JTLMMPixelConverter pixelConverter = new JTLMM.resource.JTLMM.ui.JTLMMPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof JTLMM.resource.JTLMM.ui.JTLMMEditor) {
			JTLMM.resource.JTLMM.ui.JTLMMEditor emfTextEditor = (JTLMM.resource.JTLMM.ui.JTLMMEditor) editor;
