 ...
 * hovers, is a proxy.
 */
public class JTLMMHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public JTLMMHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (JTLMM.resource.JTLMM.IJTLMMTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new JTLMM.resource.JTLMM.ui.JTLMMHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
