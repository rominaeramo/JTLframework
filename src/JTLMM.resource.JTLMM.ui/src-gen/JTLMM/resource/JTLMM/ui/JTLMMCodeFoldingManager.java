 ...
 */
public class JTLMMCodeFoldingManager {
	
	private class FoldingUpdateListener implements JTLMM.resource.JTLMM.IJTLMMBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(JTLMM.resource.JTLMM.ui.JTLMMEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof JTLMM.resource.JTLMM.ui.JTLMMEditor) {
				JTLMM.resource.JTLMM.ui.JTLMMEditor editor = (JTLMM.resource.JTLMM.ui.JTLMMEditor) workbenchPart;
	...
	protected JTLMM.resource.JTLMM.ui.JTLMMEditor editor;
	 ...
	 */
	public JTLMMCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,JTLMM.resource.JTLMM.ui.JTLMMEditor textEditor) {
	...
	private void addCloseListener(final JTLMM.resource.JTLMM.ui.JTLMMEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			JTLMM.resource.JTLMM.ui.JTLMMUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		JTLMM.resource.JTLMM.IJTLMMTextResource textResource = (JTLMM.resource.JTLMM.IJTLMMTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
