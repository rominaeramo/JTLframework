...
public class JTLMMBracketSet {
	...
	private java.util.ArrayList<JTLMM.resource.JTLMM.IJTLMMBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements JTLMM.resource.JTLMM.IJTLMMBracketPair {
	 ...
	 */
	private class ClosingListener implements JTLMM.resource.JTLMM.ui.IJTLMMBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				JTLMM.resource.JTLMM.IJTLMMBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public JTLMMBracketSet(JTLMM.resource.JTLMM.ui.JTLMMEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<JTLMM.resource.JTLMM.IJTLMMBracketPair>();
	 ...
	 */
	public JTLMM.resource.JTLMM.IJTLMMBracketPair getBracketPair(String opening, String closing) {
		for (JTLMM.resource.JTLMM.IJTLMMBracketPair bracketPair : bracketPairs) {
	...
	public JTLMM.resource.JTLMM.IJTLMMBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(JTLMM.resource.JTLMM.IJTLMMBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + JTLMM.resource.JTLMM.ui.JTLMMPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public JTLMM.resource.JTLMM.IJTLMMBracketPair remove(String opening, String closing) {
		for (JTLMM.resource.JTLMM.IJTLMMBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<JTLMM.resource.JTLMM.IJTLMMBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, JTLMM.resource.JTLMM.ui.JTLMMPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, JTLMM.resource.JTLMM.ui.JTLMMPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
