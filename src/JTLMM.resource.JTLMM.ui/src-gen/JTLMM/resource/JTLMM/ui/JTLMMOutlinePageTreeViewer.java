 ...
 * a specified depth.
 */
public class JTLMMOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public JTLMMOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = JTLMM.resource.JTLMM.util.JTLMMStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof JTLMM.resource.JTLMM.ui.JTLMMEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			JTLMM.resource.JTLMM.mopp.JTLMMPlugin.logError("Exception while refreshing outline view", e);
		}
	}
