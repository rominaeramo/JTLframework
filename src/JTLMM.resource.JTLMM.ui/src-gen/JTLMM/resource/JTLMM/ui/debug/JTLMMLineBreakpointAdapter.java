...
public class JTLMMLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(JTLMM.resource.JTLMM.mopp.JTLMMPlugin.DEBUG_MODEL_ID);
			...
			JTLMM.resource.JTLMM.debug.JTLMMLineBreakpoint lineBreakpoint = new JTLMM.resource.JTLMM.debug.JTLMMLineBreakpoint(resource, lineNumber + 1);
