...
public class JTLMMDebugModelPresentation implements org.eclipse.debug.ui.IDebugModelPresentation {
	
	public JTLMMDebugModelPresentation() {
		super();
	}
	...
	public String getEditorId(org.eclipse.ui.IEditorInput input, Object element) {
		if (element instanceof org.eclipse.core.resources.IFile || element instanceof org.eclipse.debug.core.model.ILineBreakpoint) {
			return JTLMM.resource.JTLMM.ui.JTLMMUIPlugin.EDITOR_ID;
		}
		return null;
	}
