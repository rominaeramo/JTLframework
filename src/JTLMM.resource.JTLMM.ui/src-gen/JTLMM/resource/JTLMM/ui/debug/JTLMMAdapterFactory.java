 ...
 * 
 */
package JTLMM.resource.JTLMM.ui.debug;

@SuppressWarnings("restriction")
public class JTLMMAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation().getSyntaxName())) {
					return new JTLMM.resource.JTLMM.ui.debug.JTLMMLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof JTLMM.resource.JTLMM.debug.JTLMMDebugVariable) {
			final JTLMM.resource.JTLMM.debug.JTLMMDebugVariable variable = (JTLMM.resource.JTLMM.debug.JTLMMDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof JTLMM.resource.JTLMM.debug.JTLMMDebugVariable) {
			final JTLMM.resource.JTLMM.debug.JTLMMDebugVariable variable = (JTLMM.resource.JTLMM.debug.JTLMMDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							JTLMM.resource.JTLMM.debug.JTLMMDebugValue castedValue = (JTLMM.resource.JTLMM.debug.JTLMMDebugValue) value;
