 ...
 * olInput</code>.
 */
public class JTLMMDocBrowserInformationControlInput {
	
	private final JTLMMDocBrowserInformationControlInput fPrevious;
	private JTLMMDocBrowserInformationControlInput fNext;
	 ...
	 */
	public JTLMMDocBrowserInformationControlInput(JTLMMDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public JTLMMDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public JTLMMDocBrowserInformationControlInput getNext() {
		return fNext;
	}
