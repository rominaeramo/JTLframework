...
public class JTLMMNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private JTLMM.resource.JTLMM.ui.JTLMMNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public JTLMMNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new JTLMM.resource.JTLMM.ui.JTLMMNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			JTLMM.resource.JTLMM.ui.JTLMMUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			JTLMM.resource.JTLMM.ui.JTLMMUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new JTLMM.resource.JTLMM.mopp.JTLMMMetaInformation().getSyntaxName();
	}
