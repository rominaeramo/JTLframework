 ...
 */
public class JTLMMHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public JTLMMHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				JTLMM.resource.JTLMM.mopp.JTLMMPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
