 ...
 */
public class JTLMMUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "JTLMM.resource.JTLMM.ui";
	public static final String EDITOR_ID = "JTLMM.resource.JTLMM.ui.JTLMMEditor";
	...
	private static JTLMMUIPlugin plugin;
	
	public JTLMMUIPlugin() {
		super();
	}
	...
	public static JTLMMUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, JTLMMUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, JTLMMUIPlugin.PLUGIN_ID, message);
		}
		final JTLMMUIPlugin pluginInstance = JTLMMUIPlugin.getDefault();
