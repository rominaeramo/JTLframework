...
public class AbstractASPInterpreter<ResultType, ContextType> {
	...
	public ResultType interprete(org.eclipse.emf.ecore.EObject object, ContextType context) {
		...
		if (object instanceof ASP.PatternElement) {
			result = interprete_ASP_PatternElement((ASP.PatternElement) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof ASP.TerminalElement) {
			result = interprete_ASP_TerminalElement((ASP.TerminalElement) object, context);
		}
		if (result != null) {
			return result;
		}
		...
		if (object instanceof ASP.EqSimple) {
			result = interprete_ASP_EqSimple((ASP.EqSimple) object, context);
		}
		if (result != null) {
			return result;
		}
		...
		if (object instanceof ASP.ConstraintElement) {
			result = interprete_ASP_ConstraintElement((ASP.ConstraintElement) object, context);
		}
		if (result != null) {
			return result;
		}
		...
		if (object instanceof ASP.Metamodel) {
			result = interprete_ASP_Metamodel((ASP.Metamodel) object, context);
		}
		if (result != null) {
			return result;
		}
		...
		if (object instanceof ASP.LocatedElement) {
			result = interprete_ASP_LocatedElement((ASP.LocatedElement) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof ASP.FunctionParameter) {
			result = interprete_ASP_FunctionParameter((ASP.FunctionParameter) object, context);
		}
		if (result != null) {
			return result;
		}
	...
	public ResultType interprete_ASP_LocatedElement(ASP.LocatedElement locatedElement, ContextType context) {
		return null;
	}
	...
	public ResultType interprete_ASP_PatternElement(ASP.PatternElement patternElement, ContextType context) {
		return null;
	}
	
	public ResultType interprete_ASP_TerminalElement(ASP.TerminalElement terminalElement, ContextType context) {
		return null;
	}
	...
	public ResultType interprete_ASP_ConstraintElement(ASP.ConstraintElement constraintElement, ContextType context) {
		return null;
	}
	...
	public ResultType interprete_ASP_FunctionParameter(ASP.FunctionParameter functionParameter, ContextType context) {
		return null;
	}
	...
	public ResultType interprete_ASP_EqSimple(ASP.EqSimple eqSimple, ContextType context) {
		return null;
	}
	...
	public ResultType interprete_ASP_Metamodel(ASP.Metamodel metamodel, ContextType context) {
		return null;
	}
