 ...
 * <ul>
 *   <li>{@link ASP.impl.LocatedElementImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link ASP.impl.LocatedElementImpl#getCommentsBefore <em>Comments Before</em>}</li>
 *   <li>{@link ASP.impl.LocatedElementImpl#getCommentsAfter <em>Comments After</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LocatedElementImpl extends EObjectImpl implements LocatedElement {
	...
	protected EClass eStaticClass() {
		return ASPPackage.Literals.LOCATED_ELEMENT;
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ASPPackage.LOCATED_ELEMENT__LOCATION, oldLocation, location));
	}
	...
	public EList<String> getCommentsBefore() {
		if (commentsBefore == null) {
			commentsBefore = new EDataTypeEList<String>(String.class, this, ASPPackage.LOCATED_ELEMENT__COMMENTS_BEFORE);
		}
	...
	public EList<String> getCommentsAfter() {
		if (commentsAfter == null) {
			commentsAfter = new EDataTypeEList<String>(String.class, this, ASPPackage.LOCATED_ELEMENT__COMMENTS_AFTER);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ASPPackage.LOCATED_ELEMENT__LOCATION:
				return getLocation();
			case ASPPackage.LOCATED_ELEMENT__COMMENTS_BEFORE:
				return getCommentsBefore();
			case ASPPackage.LOCATED_ELEMENT__COMMENTS_AFTER:
