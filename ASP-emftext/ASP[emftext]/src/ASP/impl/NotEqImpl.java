 ...
 * <ul>
 *   <li>{@link ASP.impl.NotEqImpl#getParameterName <em>Parameter Name</em>}</li>
 *   <li>{@link ASP.impl.NotEqImpl#getRight1 <em>Right1</em>}</li>
 *   <li>{@link ASP.impl.NotEqImpl#getLeft1 <em>Left1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NotEqImpl extends ExpressionImpl implements NotEq {
	...
	public void setParameterName(String newParameterName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ASPPackage.NOT_EQ__PARAMETER_NAME, oldParameterName, parameterName));
	}
	...
	public Literal getRight1() {
		if (right1 != null && right1.eIsProxy()) {
			...
			if (right1 != oldRight1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ASPPackage.NOT_EQ__RIGHT1, oldRight1, right1));
			}
		}
		return right1;
	}
	...
	public void setRight1(Literal newRight1) {
		...
		right1 = newRight1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ASPPackage.NOT_EQ__RIGHT1, oldRight1, right1));
	}
	...
	public Literal getLeft1() {
		if (left1 != null && left1.eIsProxy()) {
			...
			if (left1 != oldLeft1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ASPPackage.NOT_EQ__LEFT1, oldLeft1, left1));
			}
		}
		return left1;
	}
	...
	public void setLeft1(Literal newLeft1) {
		...
		left1 = newLeft1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ASPPackage.NOT_EQ__LEFT1, oldLeft1, left1));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ASPPackage.NOT_EQ__PARAMETER_NAME:
				return getParameterName();
			case ASPPackage.NOT_EQ__RIGHT1:
				if (resolve) return getRight1();
				return basicGetRight1();
			case ASPPackage.NOT_EQ__LEFT1:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == FunctionParameter.class) {
			switch (derivedFeatureID) {
				case ASPPackage.NOT_EQ__PARAMETER_NAME: return ASPPackage.FUNCTION_PARAMETER__PARAMETER_NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == FunctionParameter.class) {
			switch (baseFeatureID) {
				case ASPPackage.FUNCTION_PARAMETER__PARAMETER_NAME: return ASPPackage.NOT_EQ__PARAMETER_NAME;
				default: return -1;
			}
		}
