 ...
 * <ul>
 *   <li>{@link JTLMM.essentialocl.TypeExp#getReferredType <em>Referred Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see JTLMM.essentialocl.EssentialoclPackage#getTypeExp()
 * @model
 * @generated
 */
public interface TypeExp extends OclExpression
{
   ...
   * @see JTLMM.essentialocl.EssentialoclPackage#getTypeExp_ReferredType()
   * @model ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link JTLMM.essentialocl.TypeExp#getReferredType <em>Referred Type</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
