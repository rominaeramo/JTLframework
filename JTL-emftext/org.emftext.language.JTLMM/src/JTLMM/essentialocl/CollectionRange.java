 ...
 * <ul>
 *   <li>{@link JTLMM.essentialocl.CollectionRange#getFirst <em>First</em>}</li>
 *   <li>{@link JTLMM.essentialocl.CollectionRange#getLast <em>Last</em>}</li>
 * </ul>
 * </p>
 *
 * @see JTLMM.essentialocl.EssentialoclPackage#getCollectionRange()
 * @model
 * @generated
 */
public interface CollectionRange extends CollectionLiteralPart
{
   ...
   * @see JTLMM.essentialocl.EssentialoclPackage#getCollectionRange_First()
  ...
  /**
   * Sets the value of the '{@link JTLMM.essentialocl.CollectionRange#getFirst <em>First</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see JTLMM.essentialocl.EssentialoclPackage#getCollectionRange_Last()
   * @model containment="true" required="true" ordered="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link JTLMM.essentialocl.CollectionRange#getLast <em>Last</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
