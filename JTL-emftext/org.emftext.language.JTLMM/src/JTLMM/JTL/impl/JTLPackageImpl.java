...
public class JTLPackageImpl extends EPackageImpl implements JTLPackage
{
   ...
   * @see JTLMM.JTL.JTLPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getRelation_Where(), this.getPattern(), this.getPattern_WhereOwner(), "where", null, 0, 1, Relation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRelation_When(), this.getPattern(), this.getPattern_WhenOwner(), "when", null, 0, 1, Relation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getPattern_WhereOwner(), this.getRelation(), this.getRelation_Where(), "whereOwner", null, 0, 1, Pattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getPattern_WhenOwner(), this.getRelation(), this.getRelation_When(), "whenOwner", null, 0, 1, Pattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
