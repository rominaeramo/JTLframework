 ...
 * <ul>
 *   <li>{@link JTLMM.JTL.impl.DomainImpl#isIsCheckable <em>Is Checkable</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.DomainImpl#isIsEnforceable <em>Is Enforceable</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.DomainImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.DomainImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.DomainImpl#getModel <em>Model</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.DomainImpl#getRootVariable <em>Root Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
