 ...
 * <ul>
 *   <li>{@link JTLMM.JTL.impl.TransformationImpl#getOwnedType <em>Owned Type</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.TransformationImpl#getNestedPackage <em>Nested Package</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.TransformationImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.TransformationImpl#getModelParameter <em>Model Parameter</em>}</li>
 *   <li>{@link JTLMM.JTL.impl.TransformationImpl#getRelation <em>Relation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransformationImpl extends ClassImpl implements Transformation
{
   ...
   * @ordered
   */
  protected EList<JTLMM.emof.Package> nestedPackage;
   ...
   * @generated
   */
  public EList<JTLMM.emof.Package> getNestedPackage()
  {
    if (nestedPackage == null)
    {
      nestedPackage = new EObjectResolvingEList<JTLMM.emof.Package>(JTLMM.emof.Package.class, this, JTLPackage.TRANSFORMATION__NESTED_PACKAGE);
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case JTLPackage.TRANSFORMATION__NESTED_PACKAGE:
        ...
        getNestedPackage().addAll((Collection<? extends JTLMM.emof.Package>)newValue);
        return;
      case JTLPackage.TRANSFORMATION__URI:
  ...
  {
    if (baseClass == JTLMM.emof.Package.class)
    {
