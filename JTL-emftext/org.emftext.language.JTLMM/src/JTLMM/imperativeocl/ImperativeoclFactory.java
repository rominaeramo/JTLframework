...
public interface ImperativeoclFactory extends EFactory
{
   ...
   * @generated
   */
  ImperativeoclFactory eINSTANCE = JTLMM.imperativeocl.impl.ImperativeoclFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Collector Exp</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Collector Exp</em>'.
   * @generated
   */
  CollectorExp createCollectorExp();
  ...
  /**
   * Returns a new object of class '<em>Anonymous Tuple Type</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Anonymous Tuple Type</em>'.
   * @generated
   */
  AnonymousTupleType createAnonymousTupleType();

  /**
   * Returns a new object of class '<em>Anonymous Tuple Literal Exp</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Anonymous Tuple Literal Exp</em>'.
   * @generated
   */
  AnonymousTupleLiteralExp createAnonymousTupleLiteralExp();

  /**
   * Returns a new object of class '<em>Anonymous Tuple Literal Part</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Anonymous Tuple Literal Part</em>'.
   * @generated
   */
